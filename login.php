...
$configPath = $_SERVER['DOCUMENT_ROOT'] . "/SistemAkuntansi/webservice/config.php";
    ...
    if ($cek > 0) {
        ...
        if ($data['status'] === 'Aktif') {
            ...
            echo "<script type='text/javascript'>
                    ...
                    window.location.href='index.php?link=login';
                  </script>";
        }
    } else {
        echo "<script type='text/javascript'>
